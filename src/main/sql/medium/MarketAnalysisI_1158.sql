...
-- #
-- #
-- # Write an SQL query to find for each user, the join date and the number of orde
-- #rs they made as a buyer in 2019.
-- #
...
-- # 👍 56 👎 24
/*
  Runtime: 1076 ms, faster than 36.52% of MySQL online submissions for Market Analysis I.
