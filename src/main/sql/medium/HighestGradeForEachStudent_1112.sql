...
-- #each student. In case of a tie, you should find the course with the smallest cou
-- #rse_id. The output must be sorted by increasing student_id.
-- #
...
-- Runtime: 508 ms, faster than 43.80% of MySQL online submissions for Highest Grade For Each Student.
