...
-- #two or more users travelled the same distance, order them by their name in ascen
-- #ding order.
-- #
...
-- #| Donald   | 0                  |
-- #+----------+--------------------+
-- #Elvis and Lee travelled 450 miles, Elvis is the top traveller as his name is al
-- #phabetically smaller than Lee.
...
-- Runtime: 631 ms, faster than 59.42% of MySQL online submissions for Top Travellers.
