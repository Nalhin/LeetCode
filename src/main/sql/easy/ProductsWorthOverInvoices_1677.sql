...
-- #This table contains the ID and the name of the product. The name consists of on
-- #ly lowercase English letters. No two products have the same name.
-- #
-- #
-- #
-- #
...
-- # 👍 11 👎 19
/*
  Runtime: 1324 ms, faster than 5.04% of MySQL online submissions for Product's Worth Over Invoices.
