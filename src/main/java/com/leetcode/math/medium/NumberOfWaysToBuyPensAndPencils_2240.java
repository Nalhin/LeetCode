...
// 👍 81 👎 4
/*
 O(n/m) Runtime: 72 ms, faster than 66.67% of Java online submissions for Number of Ways to Buy Pens and Pencils.
 O(1) Memory Usage: 39 MB, less than 100.00% of Java online submissions for Number of Ways to Buy Pens and Pencils.
*/
// leetcode submit region begin(Prohibit modification and deletion)

public class NumberOfWaysToBuyPensAndPencils_2240 {
