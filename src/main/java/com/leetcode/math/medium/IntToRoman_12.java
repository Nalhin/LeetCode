...
// 👍 1606 👎 3062
/*
  O(1) Runtime: 4 ms, faster than 84.99% of Java online submissions for Integer to Roman.
  O(1) Memory Usage: 37.9 MB, less than 99.65% of Java online submissions for Integer to Roman.
 */
...
public class IntToRoman_12 {
  ...
  private static final int[] integerValue = {1000, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1};
  ...
  public String intToRoman(int num) {
    ...
    while (num > 0) {
      while (integerValue[curr] > num) {
        curr++;
      }
      sb.append(stringRepresentation[curr]);
      num -= integerValue[curr];
    }
