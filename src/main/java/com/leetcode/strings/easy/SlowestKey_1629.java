...
//
// Related Topics Array String 👍 311 👎 53
/*
 O(n) Runtime: 7 ms, faster than 5.95% of Java online submissions for Slowest Key.
 O(m) Memory Usage: 39.4 MB, less than 26.27% of Java online submissions for Slowest Key.
*/
...
public class SlowestKey_1629 {
  public char slowestKey(int[] releaseTimes, String keysPressed) {
    ...
    for (int i = 0; i < releaseTimes.length; i++) {
      times.merge(keysPressed.charAt(i), releaseTimes[i] - prev, Integer::max);
      prev = releaseTimes[i];
    }
