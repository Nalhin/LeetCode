...
// 👍 851 👎 94
/*
 O(n) Runtime: 0 ms, faster than 100.00% of Java online submissions for Shuffle the Array.
 O(n) Memory Usage: 39.6 MB, less than 12.55% of Java online submissions for Shuffle the Array.
*/
