...
/*
   O(n) Runtime: 4 ms, faster than 12.57% of Java online submissions for Kids With the Greatest Number of Candies.
   O(n) Memory Usage: 38.4 MB, less than 99.90% of Java online submissions for Kids With the Greatest Number of Candies.
*/
