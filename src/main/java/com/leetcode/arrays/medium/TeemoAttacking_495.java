...
/*
   O(n) Runtime: 2 ms, faster than 64.16% of Java online submissions for Teemo Attacking.
   O(1) Memory Usage: 41.4 MB, less than 96.04% of Java online submissions for Teemo Attacking.
*/
