...
/*
 * // This is the ImmutableListNode's API interface. // You should not implement it, or speculate
 * about its implementation. interface ImmutableListNode { public void printValue(); // print the
 * value of this node. public ImmutableListNode getNext(); // return the next node. };
 */
/*
  O(n) Runtime: 0 ms, faster than 100.00% of Java online submissions for Print Immutable Linked List in Reverse.
  O(n) Memory Usage: 37.5 MB, less than 97.83% of Java online submissions for Print Immutable Linked List in Reverse.
 */
