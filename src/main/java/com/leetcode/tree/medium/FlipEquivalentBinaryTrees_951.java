 ...
 */
/*
 O(min(n1,n2)) Runtime: 0 ms, faster than 100.00% of Java online submissions for Flip Equivalent Binary Trees.
 O(min(n1h, n2h)) Memory Usage: 36.8 MB, less than 54.07% of Java online submissions for Flip Equivalent Binary Trees.
*/
