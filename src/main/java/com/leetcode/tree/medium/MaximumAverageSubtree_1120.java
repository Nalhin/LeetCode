 ...
 */
/*
 O(n) Runtime: 0 ms, faster than 100.00% of Java online submissions for Maximum Average Subtree.
 O(h) Memory Usage: 39.5 MB, less than 34.18% of Java online submissions for Maximum Average Subtree.
*/
public class MaximumAverageSubtree_1120 {
  ...
  private int[] maxDfs(TreeNode root) {
    ...
    double currMax = (double) currSum / currCount;
