...
/*
 O(n) Runtime: 0 ms, faster than 100.00% of Java online submissions for Trim a Binary Search Tree.
 O(h) Memory Usage: 38.5 MB, less than 92.68% of Java online submissions for Trim a Binary Search Tree.
*/
