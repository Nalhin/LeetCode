...
// Topics Array Hash Table Stack Monotonic Stack 👍 1181 👎 95
/*
 O(n+m) Runtime: 3 ms, faster than 89.28% of Java online submissions for Next Greater Element I.
 O(n+m) Memory Usage: 39.4 MB, less than 46.59% of Java online submissions for Next Greater Element I.
*/
...
public class NextGreaterElementI_496 {
  public int[] nextGreaterElement(int[] nums1, int[] nums2) {
    ...
    int lastNum = nums2[nums2.length - 1];
    stack.push(lastNum);
    map.put(lastNum, -1);
