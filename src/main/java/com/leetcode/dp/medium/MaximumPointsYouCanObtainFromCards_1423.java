...
/*
 O(n) Runtime: 1 ms, faster than 100.00% of Java online submissions for Maximum Points You Can Obtain from Cards.
 O(1) Memory Usage: 48.4 MB, less than 49.42% of Java online submissions for Maximum Points You Can Obtain from Cards.
*/
