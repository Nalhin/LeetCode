...
/*
 O(n) Runtime: 0 ms, faster than 100.00% of Java online submissions for Get Maximum in Generated Array.
 O(n) Memory Usage: 35.7 MB, less than 38.50% of Java online submissions for Get Maximum in Generated Array.
*/
